...
import {MovieDeatiles, MovieList, PageNotFound, Search} from "../pages"
export const AllRoutes = () => {
  return (
    <>
      <Routes>
        <Route path="/" element={<MovieList title="Your Guided to Great Movies" apiPath="movie/now_playing" />} />
        <Route path="/movies/popular" element={<MovieList title="Populer Movies " apiPath="movie/popular" />} />
        ...
        <Route path="movie/:id" element={<MovieDeatiles/>} />
